...
![Plugin](https://img.shields.io/badge/plugin-v1.3.2-ec4899)
...
- ✨ 宽屏（分栏）模式三栏工具栏
- ✨ **新增逐字歌词（KTV）引擎 -此功能对于移动端（网页及安卓端的性能来说，只能说聊胜于无，时间轴试了很多方案都没办法准确）**
...
1. 从 [Releases](https://github.com/MbAIGC/songloft-plugin-iwebplayer-S/releases) 下载 `iwebplayer-s-v1.3.2.jsplugin.zip`；
...
> 📌 APK 与插件在同一 Release 中发布：APK 从 **v0.0.1** 开始计数，插件版本为 **1.3.2**。
...
- `iwebplayer-s-v1.3.2.jsplugin.zip` — 可直接安装到 SongLoft
